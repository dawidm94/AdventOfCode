...
public class Day05_2 {
    ...
    private static final Integer DEFAULT_INPUT_INTEGER = 5;
    ...
    public static void main(String[] args) throws Exception {
        for (Integer i = 0; i < input.size(); i++) {
            ...
            if (input.get(i) == 99) {
                ...
                if (oppcode == 1 || oppcode == 2 || oppcode == 7 || oppcode == 8) {
                    ...
                    if (oppcode == 1) {
                    	...
                    	if (firstParam < secondParam) {
                    		input.set(thirdParam, 1);
						} else {
                    		input.set(thirdParam, 0);
						}
					} else if (oppcode == 8) {
                ...
                i = increaseIndex(i, oppcode);
            }
        }
    }

    private static Integer increaseIndex(Integer index, Integer oppcode) {
    ...
    private static Integer getValueAtIndex(Integer index, boolean isImmediateMode) {
