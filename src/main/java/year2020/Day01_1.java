	...
	public static void main(String[] args) {
		...
		for (int i = 0; i< INPUT.length; i++) {
			for (int j = 0; j< INPUT.length; j++) {
				if (i != j) {
					if (INPUT[i] + INPUT[j] == EXPECTED_RESULT) {
		...
		System.out.printf("First number: %d, second number: %d, multiplication of them...", firstSolutionNumber, secondSolutionNumber);
		System.out.println(".. ANDDDD THE RESULT OF TODAY TASK....");
		System.out.println("ISSSSSS.....");
		System.out.println("**************");
		System.out.println(firstSolutionNumber * secondSolutionNumber);
		System.out.println("**************");
	}
}
