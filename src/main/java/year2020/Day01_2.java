...
public class Day01_2 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("First number: %d, second number: %d, third number: %d, multiplication of them...", firstSolutionNumber, secondSolutionNumber, thirdSolutionNumber);
		System.out.println(".. ANDDDD THE RESULT OF TODAY SECOND TASK....");
		...
		System.out.println(".");
		System.out.println("**************");
		System.out.println(firstSolutionNumber * secondSolutionNumber * thirdSolutionNumber);
		System.out.println("**************");
	}
}
